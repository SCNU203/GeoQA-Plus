...
class Encoder(Model):
    def __init__(self,
        ...
        self.lstm = torch.nn.LSTM(hid_dim, hid_dim, batch_first=True, bidirectional=True , num_layers=2, dropout=0.5)
...
class SimpleSeq2Seq(Model):
    ...
    def forward(self,  # type: ignore
                image, source_nums, choice_nums, label, type,
